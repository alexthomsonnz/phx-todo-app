defmodule PhxTodoWeb.ItemController do
  ...
  def index(conn, params) do
    ...
    render(conn, "index.html", items: items, changeset: changeset, editing: item, filter: Map.get(params, "filter", "all"))
  end
